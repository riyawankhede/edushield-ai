...
export default function ParentAisummaryPage() {
  return (
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight sm:text-3xl flex items-center gap-2">
              ...
              AI Weekly Student Summary
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-10">
            Automated weekly academic and well-being synthesis for your child.
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              AI Weekly Student Summary Overview
            </CardTitle>
          ...
          <CardDescription>
            Synthesized progress report with actionable parenting tips.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">AI Weekly Student Summary Console</h3>

        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight sm:text-3xl flex items-center gap-2">
              ...
              Well-being & Daily Check-in
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-10">
            Log your daily mood check-in and access student support resources.
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Well-being & Daily Check-in Overview
            </CardTitle>
          ...
          <CardDescription>
            Confidential mood tracking and wellness support tools.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">Well-being & Daily Check-in Console</h3>
            ...
            <div className="pt-2">
              <Link href="/student">
                <Button variant="outline" size="sm">
                  <ArrowLeft className="h-4 w-4 mr-2" /> Return to Student Dashboard
                </Button>
              </Link>
            </div>
          </div>

      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground ml-10">
            Institutional analytics on academic trends, well-being indices, and retention forecasts.
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              AI Predictive Analytics Overview
            </CardTitle>
          ...
          <CardDescription>
            Executive predictive intelligence dashboards.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">AI Predictive Analytics Console</h3>

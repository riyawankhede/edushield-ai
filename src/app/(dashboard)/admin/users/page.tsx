    ...
    <div className="flex flex-col gap-6 w-full min-w-0">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground ml-10">
            RBAC management, account provisioning, and security permissions.
          </p>
        </div>
      ...
      <Card className="border-border shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Role-based access controls and user credentials.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">User Access & Roles Console</h3>

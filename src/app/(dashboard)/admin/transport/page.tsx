...
import { ArrowLeft, Bus, CheckCircle2, Clock, Sparkles } from "lucide-react"
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground ml-10">
            School bus fleet tracking, route optimization, and driver assignments.
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Fleet & Transport Management Overview
            </CardTitle>
          ...
          <CardDescription>
            Bus fleet monitoring and route anomaly logs.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">Fleet & Transport Management Console</h3>

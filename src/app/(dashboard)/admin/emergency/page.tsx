      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground ml-10">
            Broadcast campus-wide alerts, initiate lockdowns, and coordinate first responder protocols.
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Emergency Response Hub Overview
            </CardTitle>
          ...
          <CardDescription>
            Instant emergency broadcast controls and safety logs.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">Emergency Response Hub Console</h3>
            ...
            <div className="pt-2">
              <Link href="/admin">
                <Button variant="outline" size="sm">
                  <ArrowLeft className="h-4 w-4 mr-2" /> Return to Admin Dashboard
                </Button>
              </Link>
            </div>
          </div>

...
import { ArrowLeft, CheckCircle2, Clock, HeartPulse, Sparkles } from "lucide-react"
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight sm:text-3xl flex items-center gap-2">
              ...
              Well-being Case Management
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-10">
            Monitor daily mood trends, qualitative student check-ins, and distress signals.
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Well-being Case Management Overview
            </CardTitle>
          ...
          <CardDescription>
            Case timeline, mood degradation flags, and notes.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">Well-being Case Management Console</h3>

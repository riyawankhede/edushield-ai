...
import { ArrowLeft, CheckCircle2, Clock, ShieldAlert, Sparkles } from "lucide-react"

export default function CounselorSafetyPage() {
  return (
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground ml-10">
            Review, investigate, and resolve confidential and anonymous safety reports.
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Safety Reports Triage Overview
            </CardTitle>
          ...
          <CardDescription>
            Anonymous report queue and investigation workflows.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">Safety Reports Triage Console</h3>

...
import { AlertTriangle, ArrowLeft, CheckCircle2, Clock, Sparkles } from "lucide-react"

export default function CounselorRiskPage() {
  return (
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight sm:text-3xl flex items-center gap-2">
              ...
              Multi-Factor Risk Insights
            </h1>
          </div>
          <p className="text-sm text-muted-foreground ml-10">
            Explainable AI risk scoring and early warning alerts across attendance, mood, and grades.
          </p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Multi-Factor Risk Insights Overview
            </CardTitle>
          ...
          <CardDescription>
            SHAP-attributed risk score breakdowns.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">Multi-Factor Risk Insights Console</h3>
            ...
            <div className="pt-2">
              <Link href="/counselor">
                <Button variant="outline" size="sm">
                  <ArrowLeft className="h-4 w-4 mr-2" /> Return to Counselor Dashboard
                </Button>
              </Link>
            </div>
          </div>

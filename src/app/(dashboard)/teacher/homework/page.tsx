...
import { ArrowLeft, CheckCircle2, ClipboardList, Clock, Sparkles } from "lucide-react"
    ...
    <div className="flex flex-col gap-6 w-full min-w-0">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground ml-10">
            Create new assignments, set deadlines, and review student submissions.
          </p>
        </div>
      ...
      <Card className="border-border shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Assignment creation and submission grading panel.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="rounded-lg border border-dashed p-6 text-center space-y-3 bg-muted/10">
            ...
            <h3 className="font-semibold text-base">Homework Management Console</h3>
            ...
            <div className="pt-2">
              <Link href="/teacher">
                <Button variant="outline" size="sm">
                  <ArrowLeft className="h-4 w-4 mr-2" /> Return to Teacher Dashboard
                </Button>
              </Link>
            </div>
          </div>
